...
router.post('/', async (req, res) => {
    ...
    // Note: We are skipping the user check for now for simplicity, 
    // but normally we would get req.user._id from a middleware

    const product = new Product({
        name: 'Sample Name',
        price: 0,
        user: req.body.user || "65f1a2b3c4d5e6f7a8b9c0d1", // Placeholder ID or passed from body
